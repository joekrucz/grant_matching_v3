...
# Set default PORT environment variable (Railway will override this with actual port)
ENV PORT=8080
...
# Use ENTRYPOINT so it always runs, Railway can still override with start command if needed
